defmodule TableFormatterTest do
  ...
  test "split_into_columns" do
    ...
    first_column = assert List.first(columns)
    last_column = assert List.last(columns)
    assert length(columns) == length(@headers)
    assert first_column = ["r1 c1, r2 c1, r3 c1, r4 c1"]
    assert last_column = ["r1+++c4, r2 c4, r3 c4, r4 c4"]
  end
